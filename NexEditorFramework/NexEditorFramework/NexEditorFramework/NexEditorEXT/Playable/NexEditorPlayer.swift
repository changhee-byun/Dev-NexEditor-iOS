...
public class NexEditorPlayer: Playable {
    ...
    private let nexEditorExt: NexEditorExt
    private var editor: NXEEngine { return nexEditorExt.nxeEngine }
    
    public init(nexEditorExt: NexEditorExt) {
        self.nexEditorExt = nexEditorExt
        self.nexEditorExt.player = self
