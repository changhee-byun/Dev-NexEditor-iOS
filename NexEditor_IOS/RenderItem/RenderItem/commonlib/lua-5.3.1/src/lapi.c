...
LUA_API void* lua_getRenderItemContext(lua_State *L){

  return L->prender_item_context_;
}

LUA_API void lua_setRenderItemContext(lua_State* L, void* pctx){

  L->prender_item_context_ = pctx;
}
