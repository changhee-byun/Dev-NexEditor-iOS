...
import com.nexstreaming.app.assetstore.zte.asset.category.CategoryAssetItem;
import com.nexstreaming.app.assetstorezte.R;
import com.nexstreaming.app.assetstore.zte.asset.category.CategoryItem;
...
//        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        onBindListItemHolder((CategoryAssetItemHolder) holder, position, (CategoryAssetItem) getItem(position));
    }
...
//                    view.getContext().startActivity(intent);
    ...
    private void updateFailure(CategoryAssetItemHolder holder){
        ...
        holder.button.setVisibility(View.VISIBLE);
        holder.downloadingLayout.setVisibility(View.GONE);
        DialogUtil.showDownloadFailAlertDialog(holder.button.getContext(), new DialogInterface.OnClickListener() {
            @Override
