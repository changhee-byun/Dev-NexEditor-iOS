...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private float CURRENT_POS_PADDING;
    ...
    private double normalizedIndicateValue = 0d;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        CURRENT_POS_PADDING = dpToPx(context, 2);
    ...
    public T getIndicateMarkValue() {
        return normalizedToValue(normalizedIndicateValue);
    }

    public void setIndicateMarkValue(T value) {
        normalizedIndicateValue = Math.max(0d, Math.min(1d, valueToNormalized(value)));
        invalidate();
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (pressedThumb != null) {
                    ...
                    if (notifyWhileDragging && listener != null) {
                        ...
                        listener.onRangeSeekBarValuesChanged(this,isMin, getSelectedMinValue(), getSelectedMaxValue());
                    }
                }
                break;
            case MotionEvent.ACTION_UP:
                ...
                invalidate();
                if (listener != null) {
                    listener.onRangeSeekBarStop(this, isMin, getSelectedMinValue(), getSelectedMaxValue());
                }
                break;
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        */
        ...
        canvas.drawRect(normalizedToScreen(normalizedIndicateValue), mRect.bottom-thumbHalfWidth, normalizedToScreen(normalizedIndicateValue) + CURRENT_POS_PADDING, mRect.bottom+thumbHalfWidth, paint);
    ...
    public interface OnRangeSeekBarChangeListener<T> {
        ...
        public void onRangeSeekBarValuesChanged(RangeSeekBar<?> bar, boolean isMin, T minValue, T maxValue);
        public void onRangeSeekBarStop(RangeSeekBar<?> bar, boolean isMin, T minValue, T maxValue);
    }
