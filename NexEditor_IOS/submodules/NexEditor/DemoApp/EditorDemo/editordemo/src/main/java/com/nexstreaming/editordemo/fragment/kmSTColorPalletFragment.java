 ...
 */
public class kmSTColorPalletFragment extends Fragment implements View.OnClickListener {
...
//        Log.d("colorPallet", "title="+title+" color="+color);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_km_stcolorpallet, container, false);
