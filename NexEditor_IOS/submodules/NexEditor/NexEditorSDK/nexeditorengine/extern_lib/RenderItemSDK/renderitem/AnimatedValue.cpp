...
void NXT_Node_AnimatedValue::processKeyFrameAttr(NXT_Node_KeyFrame* kf, char* attrName, char* attrValue){
	...
	if (0 == strcasecmp(attrName, "time")) {
		RITM::NXT_FloatVectorFromString(attrValue, &kf->t, 1);
	}
	else if (0 == strcasecmp(attrName, "value")) {
		kf->element_count = RITM::NXT_FloatVectorFromString(attrValue, kf->e, sizeof(kf->e) / sizeof(*(kf->e)));
	}
		...
		if (0 == strcasecmp(attrValue, "ease")) {
			...
			RITM::NXT_FloatVectorFromString(attrValue, kf->timing, 4);
		}
...
void NXT_Node_AnimatedValue::setAttr(char* attrName, char* attrValue){
	...
	if (0 == strcasecmp(attrName, "id")){
		...
		if (0 == strcasecmp(attrValue, "ease")) {
			...
			RITM::NXT_FloatVectorFromString(attrValue, timing, 4);
		}
		...
		RITM::NXT_FloatVectorFromString(attrValue, &startTime, 1);
	}
	else if (0 == strcasecmp(attrName, "end")) {
		RITM::NXT_FloatVectorFromString(attrValue, &endTime, 1);
	}
	else if (0 == strcasecmp(attrName, "noisebias")) {
		RITM::NXT_FloatVectorFromString(attrValue, &noiseBias, 1);
	}
	else if (0 == strcasecmp(attrName, "noisescale")) {
		RITM::NXT_FloatVectorFromString(attrValue, &noiseScale, 1);
	}
	else if (0 == strcasecmp(attrName, "noisesamplebias")) {
		RITM::NXT_FloatVectorFromString(attrValue, &noiseSampleBias, 1);
	}
	else if (0 == strcasecmp(attrName, "noisesamplescale")) {
		RITM::NXT_FloatVectorFromString(attrValue, &noiseSampleScale, 1);
	}
	else if (0 == strcasecmp(attrName, "noiseoctaves")) {
		float octaves = 0.0;
		RITM::NXT_FloatVectorFromString(attrValue, &octaves, 1);
