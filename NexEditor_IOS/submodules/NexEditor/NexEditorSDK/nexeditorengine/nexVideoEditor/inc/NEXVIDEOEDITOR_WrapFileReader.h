...
#ifndef __NEXVIDEOEDITOR_WRAPFILEREADER_H__
#define __NEXVIDEOEDITOR_WRAPFILEREADER_H__
...
class CNexFileReader : public CNexSource
{
public:
    CNexFileReader();
	virtual ~CNexFileReader();
...
typedef std::vector<CNexFileReader*>	FileReaderVec;
typedef FileReaderVec::iterator			FileReaderVecIter;
