...
#ifndef __NEXVIDEOEDITOR_WRAPOUTSOURCE_H__
#define __NEXVIDEOEDITOR_WRAPOUTSOURCE_H__
...
class CNexOutSource : public CNexSource
{
public:
    CNexOutSource();
	virtual ~CNexOutSource();
...
public:
	...
	NEXSALFileHandle			m_pOutSource;
	NEXSALMutexHandle		m_hOutSourceMutex;
...
#endif // __NEXVIDEOEDITOR_WRAPOUTSOURCE_H__
