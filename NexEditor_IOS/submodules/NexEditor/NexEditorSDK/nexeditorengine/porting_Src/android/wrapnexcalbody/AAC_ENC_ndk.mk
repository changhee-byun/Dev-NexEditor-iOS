...
LOCAL_C_INCLUDES += \
		...
		$(WRAPNEXCALBODY_TOP)/../../../extern_lib/AAC_Encoder

LOCAL_CFLAGS += -DAACEnc_CALBODY
# To hide symbol
LOCAL_CFLAGS += -fvisibility=hidden

ifeq ($(TARGET_ARCH),x86)

LOCAL_LDFLAGS +=	-L$(WRAPNEXCALBODY_TOP)/../../../extern_lib/AAC_Encoder/ \
					-lNxAACEnc_linux_x86_release

else ifeq ($(TARGET_ARCH),x86_64)

LOCAL_LDFLAGS +=	-L$(WRAPNEXCALBODY_TOP)/../../../extern_lib/AAC_Encoder/ \
					-lNxAACEnc_linux_x86_64_release

else ifeq ($(TARGET_ARCH),arm64)

LOCAL_LDFLAGS +=	-L$(WRAPNEXCALBODY_TOP)/../../../extern_lib/AAC_Encoder/ \
					-lNxAACEnc_android_arm64-v8a_release
else

LOCAL_ARM_MODE := arm

LOCAL_LDFLAGS +=	-L$(WRAPNEXCALBODY_TOP)/../../../extern_lib/AAC_Encoder/ \
					-lNxAACEnc_android_armv7_release
endif
...
LOCAL_MODULE := libnexcalbody_aacenc
