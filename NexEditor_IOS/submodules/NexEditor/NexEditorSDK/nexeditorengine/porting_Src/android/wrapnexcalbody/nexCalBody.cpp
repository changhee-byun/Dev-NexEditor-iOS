...
unsigned int nexCALBody_Video_GetProperty( unsigned int uProperty, NXINT64 *puValue, void* uUserData )
{
	...
	case NEXCAL_PROPERTY_VIDEO_OUTPUT_BUFFER_TYPE :
		*puValue = (NXINT64)NEXCAL_PROPERTY_VIDEO_BUFFER_NOT_MEMORY;
		break;
	case NEXCAL_PROPERTY_BYTESTREAM_FORMAT:
		*puValue = (NXINT64)NEXCAL_PROPERTY_BYTESTREAMFORMAT_ANY;
		break;
	...
	case NEXCAL_PROPERTY_AVC_SUPPORT_TO_INCLUDE_CONFIGSTREAM:
		*puValue = (NXINT64)NEXCAL_PROPERTY_AVC_SUPPORT_TO_INCLUDE_CONFIGSTREAM_OK;
		break;
	case NEXCAL_PROPERTY_AVC_SUPPORT_PROFILE:
		*puValue = (NXINT64)66;//NEXAVCProfile_BASELINE;
		break;		
	...
	case NEXCAL_PROPERTY_USE_IFRAME_WHEN_VDEC_INIT :
		*puValue = (NXINT64)NEXCAL_PROPERTY_USE_IFRAME_WHEN_VDEC_INIT_YES;//;NEXCAL_PROPERTY_INIT_DECODER_PARTIAL
		break;

	case NEXCAL_PROPERTY_MPEG4_SIMPLE_PROFILE_LEVEL3_SUPPORT:
		*puValue = (NXINT64)NEXCAL_PROPERTY_MPEG4_SIMPLE_PROFILE_LEVEL3_SUPPORT_YES;//NEXCAL_PROPERTY_MPEG4_SIMPLE_PROFILE_LEVEL3_SUPPORT_NO;
		break;
	/*
...
unsigned int nexCALBody_Audio_GetProperty( unsigned int uProperty, NXINT64 *puValue, void* uUserData )
{
	...
	{
	case NEXCAL_PROPERTY_CODEC_IMPLEMENT:
		*puValue = (NXINT64)NEXCAL_PROPERTY_CODEC_IMPLEMENT_HW;
		break;
	case NEXCAL_PROPERTY_NEED_EXCLUSIVE_RENDERER :
		*puValue = (NXINT64)NEXCAL_PROPERTY_ANSWERIS_YES;
		break;
	case NEXCAL_PROPERTY_SUPPORT_TO_AAC_MUTE_FRAME :
		...
		*puValue = (NXINT64)NEXCAL_PROPERTY_SUPPORT_TO_AAC_MUTE_FRAME_NO;
		break;
	...
	case NEXCAL_PROPERTY_SUPPORT_TO_AAC_ADTSHEADER :
		*puValue = (NXINT64)NEXCAL_PROPERTY_SUPPORT_TO_AAC_ADTSHEADER_YES;
		break;	
	// JDKIM : end	
