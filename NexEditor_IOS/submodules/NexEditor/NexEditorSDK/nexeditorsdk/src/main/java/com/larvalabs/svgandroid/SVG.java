...
import com.nexstreaming.app.common.drawable.ScalablePictureDrawable;
...
public class SVG {
    ...
    private final Set<Integer> originalColors;
     ...
     */
    SVG(Picture picture, RectF bounds, Set<Integer> originalColors) {
    ...
    public PictureDrawable createPictureDrawable() {
        return new ScalablePictureDrawable(picture);
...
//        };
    ...
    public Set<Integer> getOriginalColors() {
