 ...
 * keys.
 *
 * {@link org.keyczar.Crypter} objects should be used with symmetric or private key sets to
 * decrypt data.
 *
...
public class Encrypter extends Keyczar {
   ...
   * @throws org.keyczar.exceptions.KeyczarException If the key set contains no primary encrypting key.
   */
   ...
   * @throws org.keyczar.exceptions.KeyczarException If there is a JCE exception or the key set does
   ...
   * @throws org.keyczar.exceptions.KeyczarException If there is a JCE exception, the key set does
