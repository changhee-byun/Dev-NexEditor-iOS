...
public class GenericKeyczar extends Keyczar {
   ...
   * @throws org.keyczar.exceptions.KeyczarException if invalid version number or trying to promote
   * a primary key.
   */
   ...
   * @throws org.keyczar.exceptions.KeyczarException if invalid version number or trying to demote
   ...
   * @throws org.keyczar.exceptions.KeyczarException if key type is unsupported.
   */
...
//    LOG.debug(Messages.getString("Keyczar.NewVersion", version));
   ...
   * @throws org.keyczar.exceptions.KeyczarException if version number doesn't exist
   */
   ...
   * @throws org.keyczar.exceptions.KeyczarException if version number nonexistent or key is not
   ...
   * @throws org.keyczar.exceptions.KeyczarException if unable to export key set.
   */
   ...
   * @throws org.keyczar.exceptions.KeyczarException if unable to write to given location.
   */
   ...
   * @throws org.keyczar.exceptions.KeyczarException If unable to write to a given location
   */
   ...
   * @throws org.keyczar.exceptions.KeyczarException if unable to write to file.
   */
