...
public abstract class KeyczarKey {
   ...
   * @throws org.keyczar.exceptions.KeyczarException for unsupported key types
   */
   ...
   *
   * Custom {@link org.keyczar.interfaces.KeyType}s should be immutable singletons, Note that
   * defining custom key types is strongly discouraged for most applications.
   *
   * This method is just a proxy to
   * {@link org.keyczar.interfaces.KeyType.KeyTypeDeserializer#registerType}
   *
   ...
   * @throws org.keyczar.exceptions.KeyczarException if type mismatch with JSON input or unsupported
   * key type
   */
