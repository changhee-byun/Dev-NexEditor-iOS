...
/**
 * A {@link org.keyczar.SessionCrypter} encrypts and decrypts session key encrypted data.
 * The session key is encrypted and made available as session material so that
 * remote {@link org.keyczar.SessionCrypter}s can be created.
 *
...
public class SessionCrypter {
   ...
   * @throws org.keyczar.exceptions.KeyczarException If there is an error instantiating a Crypter
   */
   ...
   * @throws org.keyczar.exceptions.KeyczarException If there is an error during decryption
   */
   ...
   * {@link org.keyczar.SessionCrypter}'s.
   *
