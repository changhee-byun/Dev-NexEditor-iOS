...
*
* {@link org.keyczar.Signer} objects should be used with symmetric or private key sets to
* generate signatures.
*
...
public class Verifier extends Keyczar {
   ...
   * @throws org.keyczar.exceptions.KeyczarException In the event of an IO error reading keys or if the
   ...
   * @throws org.keyczar.exceptions.KeyczarException If the signature is malformed or a JCE error
   * occurs.
   */
   ...
   * @throws org.keyczar.exceptions.KeyczarException If an error occurred while
   ...
   * @throws org.keyczar.exceptions.KeyczarException If the signature fails to verify.
   */
   ...
   * @throws org.keyczar.exceptions.KeyczarException if unable to get attached blob.
   */
