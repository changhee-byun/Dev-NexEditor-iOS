...
public interface EncryptingStream extends Stream {
   ...
   * @throws org.keyczar.exceptions.KeyczarException If there is any error initializing this Stream;
   ...
   * @return The number of bytes written to the output.
   * @throws org.keyczar.exceptions.KeyczarException If a Java JCE error occurs or the output buffer
   *                          is too small.
   */
