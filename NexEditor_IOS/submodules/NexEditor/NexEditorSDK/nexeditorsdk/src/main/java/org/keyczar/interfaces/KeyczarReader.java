...
public interface KeyczarReader {
   ...
   * @throws org.keyczar.exceptions.KeyczarException If an error occurs while attempting to read data,
   *         e.g. an IOException
   */
   ...
   * @throws org.keyczar.exceptions.KeyczarException If a primary key is not found or a load error
   *         occurs.
   */
