...
public interface SigningStream extends Stream {
   ...
   *
   * @throws org.keyczar.exceptions.KeyczarException If any Java JCE errors occur
   */
   ...
   * @throws org.keyczar.exceptions.KeyczarException If any Java JCE errors occur or the output buffer
   *                          is too small.
   */
